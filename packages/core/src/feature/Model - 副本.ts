        ...
        this.traverse((child) => {
            if (child instanceof Mesh && child.material) {
                ...
                if (child.name === 'building') {
                    renderCity(child, {
                        materialColor: new Color("#335a80").multiplyScalar(3),
                        topColor: "#B7E1F7",
                        flowColor: "#FFFFFF",
                        effectColor: "#FFFFFF",
                        opacity: 0.8,
                ...
                if (child.name === 'grass') {
                    child.material.color = new Color("#1F7E72");
                    child.material.emissive.set('#1F7E72'); // 基础自发光
                ...
                //     color: new Color('rgb(51,90,128)').multiplyScalar(1.4),
                //     roughness: 0.8,
                //     metalness: 0,
                //     transparent: true,
                //     opacity:  0.8,
